...
def check_key_down_events(event, ai_settings, screen, stats, ship,
                          aliens, bullets):
...
def check_events(ai_settings, screen, stats, play_btn, aliens,
                 ship, bullets):
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            check_key_down_events(event, ai_settings, screen, stats,
                                  ship, aliens, bullets)
...
def check_play_button(ai_settings, screen, stats, play_btn, ship, aliens,
